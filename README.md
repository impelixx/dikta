...
- Выбор модели: 4 варианта GigaAM v3 (CTC/Transducer, с пунктуацией и без) прямо
  в приложении, плюс возможность подключить любую свою sherpa-onnx-совместимую
  модель по репозиторию Hugging Face
- Выбор микрофона и три варианта темы (крем/терракота, мятная, лавандовая)
